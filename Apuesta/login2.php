...
<body style="display:none" onload="Zoom();">
    ...
    <div class="bloque1">
        ...
        <div>
            ...
            <div class="ajuste">
              <div class="textingreso"> Datos de ingreso:</div>
               
                <input id="cedula2" type="text" placeholder="c.c" >
                <div class="textingresocod"> Ingrese su código</div>
                <input id="token" type="text"><br>
               <p  class="textreg" > Si todavia no ha  ingresado <br> sus datos <a>registrese ahora</a> </p>
                <button class="enviar" type="button ">  &nbsp Participar &nbsp
